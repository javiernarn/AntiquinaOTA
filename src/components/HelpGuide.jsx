...
// Content mirrors the actual app logic 1:1 (host client schedules, auto
// lunch/clock-out, shift-coverage rules, real-time progress, PDF export
// gating) so it never tells the trainee something the code doesn't
// actually do. Shared by both the always-available Help (?) button and the
// one-time onboarding walkthrough shown on first sign-in.
...
// a first-time user can't accidentally miss how clock-in, host clients,
// and PDF export work before they start using the app for real.
      ...
      >
        ...
        <div className="help-card-body" ref={bodyRef} onScroll={handleScroll}>
          ...
          <p className="onboarding-end-marker">
            That's everything — you're ready to set up your host client and clock in.
          </p>
        </div>
